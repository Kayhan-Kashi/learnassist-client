...
const ChatBox = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-lg flex h-[80vh]">
      {/* Chat Display Section */}
      <div className="flex-1 flex flex-col overflow-y-auto border-r border-gray-300 pr-4">
