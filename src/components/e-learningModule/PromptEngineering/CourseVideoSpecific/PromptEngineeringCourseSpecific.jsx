...
import {
  ...
  GetCourseVideoPromptEngineering,
...
// Main Component
const PromptEngineeringCourseSpecific = () => {
  ...
  useEffect(() => {
    if (courseVideoId) {
      const fetchData = async () => {
        try {
          const response = await GetCourseVideoPromptEngineering({
            courseVideoId,
          });
          if (response?.data) {
            setTextList(
...
export default PromptEngineeringCourseSpecific;
